...
--- Q1 Select Cities where total amount recieved from the customers which stayes in hotel is > 20000.
...
--- Q9 Show the rank of the city based on their total booking.
...
---Similar (Show the rank of hotels in each city based on the number of bookings)
